...
def send_tweets
	...
	client.update( "#{user} Hello I love your work, every journalist should be like you ! @thehackingproject #bonjour_monde ")
end
...
def follow_users
	tweet = client.search('#bonjour_monde', result_type: "recent").take(5).each do |tweet|
